...
begin
    position_y_1 <= std_logic_vector(to_unsigned(to_integer((unsigned(size_window_height) - unsigned(object_height)) * unsigned(value_1) / to_unsigned(511, 10)), 10));
    position_y_2 <= std_logic_vector(to_unsigned(to_integer((unsigned(size_window_height) - unsigned(object_height)) * unsigned(value_2) / to_unsigned(511, 10)), 10));

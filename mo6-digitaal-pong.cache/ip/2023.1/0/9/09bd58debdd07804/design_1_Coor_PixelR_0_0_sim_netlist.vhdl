...
\CoorR_yboven[4]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => HoogtePeddels(1),
      O => \CoorR_yboven[4]_i_6_n_0\
    );
...
\CoorR_yboven[8]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => HoogtePeddels(5),
      O => \CoorR_yboven[8]_i_5_n_0\
    );
...
\CoorR_yboven_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \CoorR_yboven[4]_i_3_n_0\,
      S(2) => \CoorR_yboven[4]_i_4_n_0\,
      S(1) => \CoorR_yboven[4]_i_5_n_0\,
      S(0) => \CoorR_yboven[4]_i_6_n_0\
    );
...
\CoorR_yboven_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(1) => \CoorR_yboven[8]_i_4_n_0\,
      S(0) => \CoorR_yboven[8]_i_5_n_0\
    );
...
PixelSig_out1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => PixelSig_out1_carry_i_2_n_0,
      S(2) => PixelSig_out1_carry_i_3_n_0,
      S(1) => PixelSig_out1_carry_i_4_n_0,
      S(0) => PixelSig_out1_carry_i_5_n_0
    );

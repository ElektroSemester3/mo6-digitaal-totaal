...
HD_PWD='D:/Vivado/mo6-digitaal-totaal/mo6-digitaal-pong.runs/design_1_aanraking_herkennen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_aanraking_herkennen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_aanraking_herkennen_0_0.tcl

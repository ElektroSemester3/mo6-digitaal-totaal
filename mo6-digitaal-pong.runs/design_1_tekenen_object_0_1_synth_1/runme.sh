...
HD_PWD='D:/Vivado/mo6-digitaal-totaal/mo6-digitaal-pong.runs/design_1_tekenen_object_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_tekenen_object_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_tekenen_object_0_1.tcl

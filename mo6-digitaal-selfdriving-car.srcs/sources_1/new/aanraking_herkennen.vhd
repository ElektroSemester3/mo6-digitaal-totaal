...
entity aanraking_herkennen is
    Port (
        ...
        x_positie_balletje : in STD_LOGIC_VECTOR (8 downto 0);
...
architecture Behavioral of aanraking_herkennen is
    ...
    signal x_positie_balletje_uns : unsigned (8 downto 0);
...
begin
    ...
    aanraking_peddel_rechts <= '1' when (x_positie_balletje_uns + grootte_balletje_uns = breedte_peddels_uns - breedte_peddels_uns) AND (y_positie_balletje_uns + grootte_balletje_uns > positie_peddel_rechts_uns) AND (y_positie_balletje_uns < positie_peddel_rechts_uns + hoogte_peddels_uns) else '0';

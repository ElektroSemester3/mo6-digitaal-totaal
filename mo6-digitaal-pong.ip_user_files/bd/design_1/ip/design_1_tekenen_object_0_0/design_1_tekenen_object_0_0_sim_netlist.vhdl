...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_tekenen_object_0_0 -prefix
--               design_1_tekenen_object_0_0_ design_1_tekenen_object_0_1_sim_netlist.vhdl
...
entity design_1_tekenen_object_0_0_tekenen_object is
  port (
...
end design_1_tekenen_object_0_0_tekenen_object;

architecture STRUCTURE of design_1_tekenen_object_0_0_tekenen_object is
  ...
  signal pixel_value_o2 : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  signal \NLW_pixel_value_o2__4_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_pixel_value_o2__4_carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
\pixel_value_o1_carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\pixel_value_o1_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
\pixel_value_o2__4_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_pixel_value_o2__4_carry__1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_pixel_value_o2__4_carry__1_O_UNCONNECTED\(3 downto 1),
      O(0) => pixel_value_o2(8),
      S(3 downto 1) => B"000",
      S(0) => \pixel_value_o2__4_carry__1_i_1_n_0\
    );
...
\pixel_value_o2_carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F2"
    )
        port map (
...
\pixel_value_o2_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_tekenen_object_0_0 is
  port (
    pixel_value_i : in STD_LOGIC;
    pxlCLK_i : in STD_LOGIC;
    HSYNC_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_tekenen_object_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_tekenen_object_0_0 : entity is "design_1_tekenen_object_0_1,tekenen_object,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_tekenen_object_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_tekenen_object_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_tekenen_object_0_0 : entity is "tekenen_object,Vivado 2023.1";
end design_1_tekenen_object_0_0;

architecture STRUCTURE of design_1_tekenen_object_0_0 is
begin
U0: entity work.design_1_tekenen_object_0_0_tekenen_object
     port map (
      HSYNC_i => HSYNC_i,
      HSYNC_o => HSYNC_o,
      VSYNC_i => VSYNC_i,
      ...
      pos_y(8 downto 0) => pos_y(8 downto 0),
      pxlCLK_i => pxlCLK_i,
      size_x(9 downto 0) => size_x(9 downto 0),
      size_y(8 downto 0) => size_y(8 downto 0),
